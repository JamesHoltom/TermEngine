--[[
	@JamesHoltom
	2022-07-08
	This file has been amended to decode TermEngine-specific types.
--]]

--[[ @JamesHoltom - "ipairs" has been copied into the context to allow it to iterate over object data. ]]

local setmetatable, tonumber, tostring, ipairs =
      setmetatable, tonumber, tostring, ipairs
local floor, inf =
...
local function newdecoder()
	...
	local function f_obj()
		...
		--[[ @JamesHoltom - This checks if an object is actually TermEngine-specific userdata before returning. ]]
		return check_for_userdata(obj)
	end
