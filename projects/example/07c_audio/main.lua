...
function Init()
  ...
  audioText = TextObject(Values.VEC2_ZERO, ivec2(26, 4))
  audioText.setText("Press 'n' to play sound\nPress 'm' to play music\nPress 'p' to pause music\nPress 'l' to loop music")

  cursorText = TextObject(vec2(0.0, 4.0), ivec2(42, 1))

  settingsText = TextObject(vec2(28.0, 0.0), ivec2(14, 4))
...
function Loop(timestep)
  ...
  if settingsChanged then
    ...
    settingsText.setText("Volume:  " .. string.format("%.1f", audioMusic.volume) ..
  ...
  if audioMusic.playing then
    cursorText.setText("Playing: " .. math.floor(audioMusic.cursor) .. "/" .. math.floor(audioMusic.length))
  elseif audioMusic.paused then
    cursorText.setText("Paused: " .. math.floor(audioMusic.cursor) .. "/" .. math.floor(audioMusic.length))
  else
    cursorText.setText("Stopped")
  end
end