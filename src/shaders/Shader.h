...
namespace term_engine::shaders {
  /// @brief Used to initialise a a shader, consisting of a shader stage type & path to a shader file.
  ...
  /**
   * @brief Compiles a GLSL string into a shader, ready to link to a program.
   * 
   ...
   * @param[in] shader The GLSL string to compile.
  ...
  /**
   * @brief Compiles a GLSL file into a shader, ready to link to a program.
   * 
   * @param[in] program_id The ID of the program to build the shader stage for.
   * @param[in] type The shader stage enum to compile for.
  ...
  /**
   * @brief Builds & links the compiled shader stages of a program.
   * 
